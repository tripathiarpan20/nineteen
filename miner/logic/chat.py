...
async def chat_stream(
    ...
    try:
        ...
        elif task_config.task == "chat-deepseek-r1-qwen-32b" and isinstance(decrypted_payload, payload_models.ChatPayload):
            address = worker_config.DEEPSEEK_R1_QWEN_32B_TEXT_WORKER_URL
        elif task_config.task == "chat-deepseek-r1-qwen-32b-comp" and isinstance(decrypted_payload, payload_models.CompletionPayload):
            address = worker_config.DEEPSEEK_R1_QWEN_32B_TEXT_COMP_WORKER_URL
