...
class WorkerConfig:
    ...
    LLAMA_3_2_3B_TEXT_COMP_WORKER_URL: str | None
    LLAMA_3_1_8B_TEXT_WORKER_URL: str | None
    LLAMA_3_1_8B_TEXT_COMP_WORKER_URL: str | None
    LLAMA_3_1_70B_TEXT_WORKER_URL: str | None
    LLAMA_3_1_70B_TEXT_COMP_WORKER_URL: str | None
    CHAT_ROGUE_ROSE_103B_COMP_WORKER_URL: str | None
    DEEPSEEK_R1_QWEN_32B_TEXT_WORKER_URL: str | None
    DEEPSEEK_R1_QWEN_32B_TEXT_COMP_WORKER_URL: str | None
...
def factory_worker_config() -> WorkerConfig:
    return WorkerConfig(
        ...
        CHAT_ROGUE_ROSE_103B_COMP_WORKER_URL=os.getenv("CHAT_ROGUE_ROSE_103B_COMP_WORKER_URL"),
        DEEPSEEK_R1_QWEN_32B_TEXT_WORKER_URL=os.getenv("DEEPSEEK_R1_QWEN_32B_TEXT_WORKER_URL"),
        DEEPSEEK_R1_QWEN_32B_TEXT_COMP_WORKER_URL=os.getenv("DEEPSEEK_R1_QWEN_32B_TEXT_COMP_WORKER_URL"),
